  ...
  return (
    <section id="contacto" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        {submissionStatus === 'success' && (<p className="text-center mt-6 text-green-600 font-bold">¡Gracias por tu mensaje! Te contactaremos pronto.</p>)}
        {submissionStatus === 'error' && (<p className="text-center mt-6 text-red-600 font-bold">Hubo un error al enviar el formulario. Por favor, inténtalo de nuevo.</p>)}
      </div>
    </section>
  );
}
