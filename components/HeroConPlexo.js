  ...
  return (
    <section className="relative flex items-center justify-center h-screen text-center overflow-hidden">
      <div className="relative z-10 p-6 flex flex-col items-center">
        <h1 className="text-6xl md:text-8xl font-extrabold leading-tight mb-4 bg-gradient-to-br from-virtus-blue-light via-white to-virtus-blue bg-clip-text text-transparent" style={{ animation: 'fade-in-up 0.5s 0.2s both', textShadow: '0 2px 10px rgba(0, 0, 0, 0.3)' }}>
          {t('hero.title')}
        </h1>
